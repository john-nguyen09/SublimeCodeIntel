    ...
    def _needToHackAroundStdHandles(cls):
        if cls.__needToHackAroundStdHandles is None:
            if sys.platform != "win32":
                ...
                stdin_handle = _winapi.GetStdHandle(STD_INPUT_HANDLE)
    ...
    def _isFileObjInheritable(cls, fileobj, stream_name):
        ...
        try:
            if fileobj is None:
                ...
                handle = subprocess.GetStdHandle(std_handle)
                if handle is None:
